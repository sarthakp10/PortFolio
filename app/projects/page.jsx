    ...
    <main>
        <div className='border-b-2 border-white/20'>
            <div className='pagetitlepos'>
                <h1 className='text-8xl font-semibold mb-2'>Work</h1>
                <p className='text-2xl text-white/35 font-semibold'>Projects and ideas I have worked on so far.</p>
            </div>
        </div>
        <div className='projectcard'>
            <div className='projtxt'>
              ...
              <Link href={'https://github.com/sarthakp10/Product-Management'} className='githubbtn flex items-center text-lg font-semibold w-fit py-1 mt-8'>
                View in GitHub
        ...
        <div className='w-3/4 mb-16 py-28 rounded-2xl border-8 border-dashed border-white/15 mx-auto bg-white/10 text-center'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-32 bg-black/30 p-5 rounded-full mx-auto text-white/40 hover:text-white duration-300 ease-in-out">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.383a14.406 14.406 0 0 1-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 1 0-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
            </svg>
            <h1 className='text-4xl font-bold my-5'><strike className='text-white/35 stroke-indigo'>Your</strike> Our Project could be here!</h1>
            <p className='text-lg text-white/25 mb-8'>Got an idea? Let's turn your imagination into reality.</p>
            <Link href={'https://mail.google.com/mail/u/0/?fs=1&to=sarthakphadnis10@gmail.com&tf=cm'} className="flex justify-evenly mx-auto  p-5 w-[18%] text-lg rounded-xl shadow-inner shadow-gray-500 hover:shadow-inner hover:shadow-gray-400 duration-300 ease-in-out">
